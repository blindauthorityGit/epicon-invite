...
export default async function saveAbmeldung(data) {
    console.log("ICH BIN DA");
    try {
        const collectionRef = collection(db, "abmeldung"); // Replace 'contacts' with the name of your collection in Firestore
        console.log(data);
        // Add a new document with the data
        await addDoc(collectionRef, data);

        // Return success or any other relevant response
        console.log("CONTACT ABGEMELDET");
